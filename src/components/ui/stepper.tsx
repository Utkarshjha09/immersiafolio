...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-lg rounded-xl shadow-xl bg-card border ${stepCircleContainerClassName}`}
      >
...
export function Step({ children }: { children: ReactNode }) {
  return <div className="px-2 pb-4 text-center">{children}</div>;
}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex h-8 w-8 items-center justify-center rounded-full font-semibold border border-border"
      >
        {status === "complete" ? (
