...
import { Code, Database, Globe, Rocket, Terminal, Braces, Cpu, PenTool } from "lucide-react";

const skillsData = [
  {
    category: "Frontend",
    icon: <Globe className="h-8 w-8 text-accent" />,
    skills: ["React", "Next.js", "JavaScript (ES6+)", "TypeScript", "HTML5", "CSS3", "Tailwind CSS", "Redux"],
  },
  {
    category: "Backend",
  ...
  },
  {
    ...
    skills: ["Verilog", "Embedded Systems", "UI/UX Design"],
  },
  {
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground md:text-xl/relaxed">
            A versatile MERN stack developer with a passion for building robust applications and exploring diverse technologies.
          </p>
        </div>
